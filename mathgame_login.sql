...
CREATE TABLE `login` (
  ...
  `hash` varchar(50) COLLATE latin1_general_cs NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `login` VALUES (1,'Kok Hong','Hean','kokhong','kokhong.hean@gmail.com','*F6B6726651C363EA2215D7AB1E729D20B7FC90B4'),(13,'zhisheng','wong','wzs','zswong@gmail.com','*6BB4837EB74329105EE4568DDA7DC67ED2CA2AD9');
